...
<script setup lang="ts">
    ...
    const credentials = reactive({
        ...
        // Para lidar om promises, podemos usar o try catch cin async/await
    // const submitLogin = async()=>{ // Uma função do tipo PROMISE
    ...
    // tambem podemos lidar com Promises usando o then/catch
    const submitLogin = ()=>{ // Uma função do tipo PROMISE
        console.log("trying to login with credentials below:", credentials);
